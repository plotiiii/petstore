...
from com.jcl.petstore.dao.account_dao import AccountDao
from com.jcl.petstore.ui.my_frame import MyFrame
from com.jcl.petstore.ui.product_list_frame import ProductListFrame
...
class LoginFrame(MyFrame):
    def __init__(self):
        ...
        fgs.AddMany([(accountid_st, 1, wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT
                      | wx.FIXED_MINSIZE),
                     (self.accountid_txt, 1, wx.CENTER | wx.EXPAND),
                     (password_st, 1, wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT
                      | wx.FIXED_MINSIZE),
        ...
        vbox.Add(hbox, -1, wx.CENTER | wx.BUTTOM, border=20)
