...
from com.jcl.petstore.dao.order_dao import OrderDao
from com.jcl.petstore.dao.order_detail_dao import OrderDetailDao
from com.jcl.petstore.dao.product_dao import ProductDao
from com.jcl.petstore.ui.cart_gridtable import CartGridTable
...
class CartFrame(MyFrame):
    ...
    def loaddata(self):
        ...
        for productid in keys:
            ...
            row['cname'] = product['cname']
            row['unitcost'] = product['unitcost']
            row['quantity'] = self.cart[productid]
            #计算商品应付金额
    ...
    def return_btn_onclick(self, event):
        ...
        for gridrowdata in self.data:
            productid = gridrowdata['productid']
            quantity = gridrowdata['quantity']
